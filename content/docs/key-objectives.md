...
description: "The key objectives driving the disclose.io project."
weight: 40
---
...
- Maintain a [vulnerability disclosure policy maturity model](/docs/diostatus-the-disclose.io-maturity-model/) and **create a "race to the top"** for VDP adoption and the implementation of best practice.
